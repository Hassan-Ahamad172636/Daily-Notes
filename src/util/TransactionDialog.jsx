...
export default function AddTransactionDialog({ isOpen, onClose }) {
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                <Button
                  ...
                  disabled={loading}
                  className="flex-1 sm:flex-none flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white"
                >
                ...
                <Button
                  variant="secondary"
                  onClick={onClose}
                  className="flex-1 sm:flex-none flex items-center gap-2 bg-slate-600 hover:bg-slate-700 text-white"
                >
                  <X className="w-4 h-4" />
                  Cancel
                </Button>
